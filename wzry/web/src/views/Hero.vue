<template>
  <div class="page-hero" v-if="model">
      <div class="topbar bg-black py-2 px-3 d-flex ai-center text-white">
        <img src="../assets/logo.png" height="31">
              ...
              <div class="p-3 bg-white border-bottom">
                ...
                <m-card plain icon="zhuangbei" title="出装推荐" class="hero-items">
                  ...
                  <div class="d-flex jc-around text-center mt-3">
                    <div v-for="item in model.items1" :key="item.naem">
                  ...
                  <div class="d-flex jc-around text-center mt-3">
                    <div v-for="item in model.items2" :key="item.naem">
                      <img :src="item.icon" class="icon">
                      <div class="fs-xs">{{item.name}}</div>
                    </div>
                  </div>
                ...
                <m-card plain icon="zhuangbei" title="使用技巧">
                  <p class="m-0">{{model.usageTips}}</p>
                </m-card>

                <m-card plain icon="zhuangbei" title="对抗技巧">
                  <p class="m-0">{{model.battleTips}}</p>
                </m-card>

                <m-card plain icon="zhuangbei" title="团战思路">
                  <p class="m-0">{{model.teamTips}}</p>
                </m-card>

                <m-card plain icon="zhuangbei" title="英雄关系">
